...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 08, 2017 at 09:53 AM
...
INSERT INTO `meeting_room` (`meeting_room_id`, `meeting_room_code`, `meeting_room_name`, `meeting_room_size`, `meeting_room_location`, `meeting_room_detail`, `meeting_room_supervise`, `meeting_room_phone`) VALUES
(1, '101', 'ห้องประชุมใหม่เอี่ยมเฮง', 40, 'อาคาร 1 ชั้น 2', 'สำหรับประชุมเรื่องทั่วไป', NULL, NULL),
(2, '201', 'ห้องประชุมโมดิฟาย', 40, 'อาคาร 1 ชั้น 3', 'สำหรับประชุมเรื่องทั่วไป', NULL, NULL),
(3, '102', 'ห้องประชุมสุดาวรรณ', 20, 'อาคาร 1 ชั้น 1', 'สำหรับประชุมหัวหน้าแผนก', NULL, NULL),
(4, '103', 'ห้องประชุมอู่เงินอู่ทอง', 40, 'อาคาร 1 ชั้น 3', 'สำหรับประชุมเรื่องทั่วไป', NULL, NULL),
(5, '104', 'ห้องประชุมฝ่ายบุคคล', 20, 'อาคาร 1 ชั้น 1', 'สำหรับประชุมฝ่าย', NULL, NULL);
...
--
ALTER TABLE `booking`
  MODIFY `booking_id` int(5) NOT NULL AUTO_INCREMENT COMMENT 'คีย์ของการจองห้องประชุม', AUTO_INCREMENT=18;
--
-- AUTO_INCREMENT for table `booking_equipment`
--
ALTER TABLE `booking_equipment`
  MODIFY `booking_equipment_id` int(5) NOT NULL AUTO_INCREMENT COMMENT 'คีย์ของการจองอุปกรณ์ที่ใช้ในการประชุม', AUTO_INCREMENT=344;
--

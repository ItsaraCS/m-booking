...
('7', 'รายงานการจอง', '2'),
('8', 'คำแนะนำการใช้งานระบบ', '2'),
('9', 'เข้าสู่ระบบ', '3'),
('10', 'สมัครสมาชิก', '3'),
('11', 'ข้อมูลส่วนตัว', '3'),
('12', 'ตั้งค่าสิทธิ์การใช้งาน', '3');
...
CREATE TABLE IF NOT EXISTS permission(
	...
	permission_created TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'วัน เวลาที่ตั้งค่าสิทธ์การใช้งาน',
	permission_update TIMESTAMP NULL COMMENT 'วัน เวลาที่แก้ไขสิทธ์การใช้งาน',
...
CREATE TABLE IF NOT EXISTS booking(
	...
	user_id INT(5) NOT NULL COMMENT 'คีย์ของผู้ใช้',
	booking_created TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'วัน เวลาที่บันทึกการจองห้องประชุม',
	booking_updated TIMESTAMP NULL COMMENT 'วัน เวลาที่แก้ไขการจองห้องประชุม',
